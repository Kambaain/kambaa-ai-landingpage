      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-foreground leading-relaxed max-w-4xl mx-auto">We feel the thrill and overwhelm of industry shifts, and we're dedicated to lightening that load for premier enterprises like yours. As AI experts, we guide you with custom strategies, intelligent automation, AI agents, and managed services, lifting operations to excellence, making you a leader, and sparking innovative products that win markets.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => <Card key={index} className="bg-gradient-to-br from-card to-secondary border-border hover:shadow-lg hover:shadow-primary/20 transition-all duration-500 transform hover:scale-105 group">
