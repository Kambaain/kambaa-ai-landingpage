...
const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat" style={{
    backgroundImage: `url(${heroBackground})`
      ...
      {/* Logo in top left */}
      <img src="/lovable-uploads/0b341369-00ee-45df-958c-4e9274953060.png" alt="Kambaa Logo" className="absolute top-8 left-8 h-16 w-auto z-20" />
        ...
        <div className="max-w-5xl mx-auto">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 text-white animate-fade-in">
            <span className="text-purple-400 drop-shadow-[0_0_10px_rgba(168,85,247,0.8)] shadow-purple-500 animate-pulse">
              Unlock Your AI Future with Kambaa's AI Ignite Masterclass
            </span>
          </h1>
          
          <p className="text-xl md:text-2xl lg:text-3xl text-gray-200 mb-12 leading-relaxed animate-fade-in">A 4 Hour Journey to Ignite Your AI Potential Worth 1999, but absolutely Free! Hurry up limited seats</p>
          
          <Button onClick={scrollToForm} size="lg" className="text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-0 shadow-2xl shadow-blue-500/50 transition-all duration-300 transform hover:scale-105 animate-pulse">
